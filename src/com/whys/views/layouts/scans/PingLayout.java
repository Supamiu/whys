...
public class PingLayout extends ScanLayout implements ScanLayoutInterface{

	private Ping ping = new Ping();
	Panel panel = new Panel("Temps de réponse serveur");
	
	public PingLayout(){
		panel.setSizeFull();
		panel.addStyleName("panel-centered-title");
		//Le listener pour si on lance le scan d'ici
		ping.addScanEndListener(new ScanEndListener() {			
			@Override
